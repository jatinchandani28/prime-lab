...
const schema = require("./validation/publish-nft-offer-schema")
    ...
    await updateNftById(nftId,
      {
        ...
        ...(nft.minPrice && { minPrice: 0 }),
        expire: body.expire
      });

    return utils.send(StatusCodes.OK, {
      message: "The NFT has been published successfully. this one is only able to sold by NFT.",
      data: nft
    });
  } catch (error) {
