...
export class TransactionService {
  ...
  async createWallet(createWalletTransaction, newPublicKey) {
    ...
    const dataToPublish = {
      ...
      args: {
        new_account_id: createWalletTransaction.senderWalletId,
        new_public_key: newPublicKey,
      },
      sender: createWalletTransaction.senderWalletId,
      tags: {
        app_id: createWalletTransaction.appId,
        action_id: createWalletTransaction.actionId,
      },
    };
    const QUEUE_URL = 'https://sqs.us-east-1.amazonaws.com/123456789012/my-queue';
